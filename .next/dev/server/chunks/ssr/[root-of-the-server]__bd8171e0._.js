...
"[project]/src/lib/security.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function hashPassword(plain) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].hash(plain, BCRYPT_ROUNDS);
}
...
function isExtensionDangerous(ext) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["DANGEROUS_EXECUTABLE_EXTENSIONS"].has(ext.toLowerCase());
}
function isExtensionEditable(ext) {
    const set = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["EDITABLE_EXTENSIONS"]);
    return set.has(ext.toLowerCase());
}
function isAllowedMime(mime) {
    if (!mime) return false;
    const lower = mime.toLowerCase().split(";")[0].trim();
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ALLOWED_MIME"].has(lower);
}
function isWithinUploadSize(sizeBytes) {
    return Number.isFinite(sizeBytes) && sizeBytes > 0 && sizeBytes <= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MAX_UPLOAD_SIZE_BYTES"];
}
async function getServerSessionUser() {
    // Lazy import so this file stays decoupled from next-auth at module load.
    const { getServerSession } = await __turbopack_context__.A("[project]/node_modules/next-auth/index.js [app-rsc] (ecmascript, async loader)");
    const { authOptions } = await __turbopack_context__.A("[project]/src/lib/auth.ts [app-rsc] (ecmascript, async loader)");
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$github$2d$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUserByUsername"])(username);
                if (!user) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].warn("auth.login.unknownUser", {
                        username
                    });
                    return null;
                }
                const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyPassword"])(password, user.passwordHash);
                if (!ok) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].warn("auth.login.badPassword", {
                        username
                    });
                    return null;
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd8171e0._.js.map