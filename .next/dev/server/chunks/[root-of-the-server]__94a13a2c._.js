...
async function GET(_req) {
    ...
    try {
        ...
        const message = err instanceof Error ? err.message : String(err);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logger"].error("stats.error", {
            message
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$security$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])("Could not compute stats: " + message, 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__94a13a2c._.js.map